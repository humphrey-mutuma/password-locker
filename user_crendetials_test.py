...
class TestCredentials(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.new_credential = Credential('Humphrey', 'twitter', 'humphrey07', '1234')

    def test__init__(self):
        """
        Test to if check the initialization/creation of credential instances is properly done
        """
        self.assertEqual(self.new_credential.user_name, 'Humphrey')
        self.assertEqual(self.new_credential.site_name, 'twitter')
        self.assertEqual(self.new_credential.account_name, 'humphrey07')
    ...
    def test_display_credentials(self):
        ...
        twitter = Credential('Humphrey', 'Twitter', 'humphrey07', '1234')
        twitter.save_credentials()
        gmail = Credential('Humphrey', 'Gmail', 'humphrey', '124')
